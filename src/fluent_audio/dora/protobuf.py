...
PROTOBUF_SCHEMA_VERSION = "fluent_audio.v1"
PROTOBUF_CODEC_KEY = "fluent_audio_codec"
PROTOBUF_SCHEMA_VERSION_KEY = "fluent_audio_schema_version"
PROTOBUF_MESSAGE_TYPE_KEY = "fluent_audio_message_type"
...
class DoraProtobufMetadata(BaseModel):
    ...
    schema_version: Literal["fluent_audio.v1"]
