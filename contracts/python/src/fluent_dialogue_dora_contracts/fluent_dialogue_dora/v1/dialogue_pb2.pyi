...
class AgentCancelRequest(_message.Message):
    __slots__ = ("session_id", "user_turn_id", "seq", "reason", "heard_text")
    SESSION_ID_FIELD_NUMBER: _ClassVar[int]
    USER_TURN_ID_FIELD_NUMBER: _ClassVar[int]
    SEQ_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    HEARD_TEXT_FIELD_NUMBER: _ClassVar[int]
    session_id: str
    user_turn_id: str
    seq: int
    reason: str
    heard_text: str
    def __init__(self, session_id: _Optional[str] = ..., user_turn_id: _Optional[str] = ..., seq: _Optional[int] = ..., reason: _Optional[str] = ..., heard_text: _Optional[str] = ...) -> None: ...
