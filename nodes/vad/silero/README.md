...
```bash
python nodes/vad/silero/main.py \
  --dora \
...
`nodes/vad/silero/models/silero_vad_16k_op15.onnx`.
...
- File: `nodes/vad/silero/models/silero_vad_16k_op15.onnx`
...
```bash
uv run --extra dev --extra dora --extra vad python -m pytest tests/contracts tests/nodes/asr tests/nodes/vad
